...
import com.briup.service.impl.KeyValueServiceImpl;
...
//    测试
    ...
    @RequestMapping("/get_late_buckle_pay")
    ...
    @RequestMapping("/get_traffic_pay")
    ...
    @RequestMapping("/get_early_buckle_pay")
    ...
    @RequestMapping("/get_missionallowance")
    ...
    @RequestMapping("/get_full_attendance_pay")
