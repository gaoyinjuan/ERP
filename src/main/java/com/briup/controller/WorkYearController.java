...
import com.briup.bean.WorkingYearsBonus;
import com.briup.service.IWorkYearService;
import com.briup.vo.WokingYearsBonusPages;
...
public class WorkYearController {
    ...
    /*查询所有数据*/
    @RequestMapping("/findWorkingYearBonusList")
    @ResponseBody
    ...
    //插入数据
    @RequestMapping("/addWorkingYearsBonus")
    @ResponseBody
