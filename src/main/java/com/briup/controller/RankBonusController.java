...
import com.briup.service.IRankBonusService;
import com.briup.vo.RankBonusPages;
...
public class RankBonusController {
    ...
    //插入数据
    @RequestMapping("/insertRankBonus")
    @ResponseBody
    ...
    @RequestMapping("/findRankBonusList")
    @ResponseBody
    ...
    //根据id删除数据
    @RequestMapping("rankBonusDelete")
    @ResponseBody
    ...
    //更新记录
    @RequestMapping("/updateRankBonus")
    @ResponseBody
